...
*Update 12/03/2017 - Custom Library Names - The local DB must be deleted & then rebuilt running the "-u" option. The TV Shows queue can be preserved by using the "-e"/"-i" options: `python PseudoChannel.py -e -u -i`*
